...
//  arduino_id  |     PinNum    |   ulPort | mode               |          configured
{
  ...
  { .arduino_id=ARDUINO_PIN_D4, 
          GPA_CFG(11, GPA11, INPUT_PULLUP),   
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_ADC|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART|PIN_ATTR_CMP|PIN_ATTR_SPI | PIN_ATTR_I2C|PIN_ATTR_DAC, 
  	                       .ADCChannel= ADC_CHANNEL_11,   .IO_irqnb=EXINT0_IRQn,    .configured=false },
  	                       
  { .arduino_id=ARDUINO_PIN_D5, 
          GPA_CFG(12, GPA12, INPUT_PULLUP),   
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_ADC|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART|PIN_ATTR_USB|PIN_ATTR_SPI, 
  ...
  { .arduino_id=ARDUINO_PIN_D13, 
          GPE_CFG(0, GPE0, INPUT_PULLUP), 
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART|PIN_ATTR_SPI|PIN_ATTR_DAC, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },
  	                       
  { .arduino_id=ARDUINO_PIN_D14, 
          GPE_CFG(1, GPE1, INPUT_PULLUP), 
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART|PIN_ATTR_SPI|PIN_ATTR_DMA, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },
  	                       
  { .arduino_id=ARDUINO_PIN_D15,
          GPE_CFG(2, GPE2, INPUT_PULLUP), 
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART|PIN_ATTR_SPI| PIN_ATTR_I2C, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },

  { .arduino_id=ARDUINO_PIN_D16,  
          GPE_CFG(3, GPE3, INPUT_PULLUP), 
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART|PIN_ATTR_SPI| PIN_ATTR_I2C, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },
...
//  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART|PIN_ATTR_SPI| PIN_ATTR_I2C, 
  ...
  { .arduino_id=ARDUINO_PIN_D24,   
          GPB_CFG(11, GPB11, INPUT_PULLUP), 
   	             .mode=PIN_ATTR_DIGITAL, 
//  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART| PIN_ATTR_I2C|PIN_ATTR_DMA, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT1_IRQn,    .configured=false },
  ...
  { .arduino_id=ARDUINO_PIN_D27, 
          GPB_CFG(13, GPB13, INPUT_PULLUP), 
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART|PIN_ATTR_DAC, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT1_IRQn,    .configured=false },
  ...
  { .arduino_id=ARDUINO_PIN_D31, 
          GPE_CFG(8, GPE8, INPUT_PULLUP), 
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },

  { .arduino_id=ARDUINO_PIN_D32,  
          GPE_CFG(9, GPE9, INPUT_PULLUP), 
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },
...
//  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART, 
  ...
  { .arduino_id=ARDUINO_PIN_D49,  
          GPE_CFG(12, GPE12, INPUT_PULLUP), 
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART|PIN_ATTR_USB|PIN_ATTR_ADC, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },
  	                       
  { .arduino_id=ARDUINO_PIN_D50, 
          GPE_CFG(13, GPE13, OUTPUT), 
            	     .mode=PIN_ATTR_DIGITAL, 
//  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART|PIN_ATTR_USB|PIN_ATTR_ADC, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },
  	                       
  { .arduino_id=ARDUINO_PIN_D51,
          GPE_CFG(14, GPE14, OUTPUT), 
            	     .mode=PIN_ATTR_DIGITAL, 
//  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART| PIN_ATTR_I2C, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },
  	                       
  { .arduino_id=ARDUINO_PIN_D52, 
          GPE_CFG(15, GPE15, OUTPUT), 
            	     .mode=PIN_ATTR_DIGITAL, 
//  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART| PIN_ATTR_I2C, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },
  	                       
  	                       
  { .arduino_id=ARDUINO_PIN_D53,  
          GPD_CFG(0, GPD0, INPUT_PULLUP), 
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART|PIN_ATTR_SPI, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },
  	                       
  { .arduino_id=ARDUINO_PIN_D54, 
          GPD_CFG(1, GPD1, INPUT_PULLUP), 
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART|PIN_ATTR_SPI, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },
  	                       
  { .arduino_id=ARDUINO_PIN_D55, 
          GPD_CFG(2, GPD2, INPUT_PULLUP), 
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART|PIN_ATTR_SPI|PIN_ATTR_USB, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },
  	                       
  { .arduino_id=ARDUINO_PIN_D56,
  ...
  { .arduino_id=ARDUINO_PIN_D64, 
          GPD_CFG(11, GPD11, INPUT_PULLUP), 
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART|PIN_ATTR_SPI|PIN_ATTR_DMA, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },
  	                       
  { .arduino_id=ARDUINO_PIN_D65,
          GPD_CFG(12, GPD12, INPUT_PULLUP), 
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_SPI|PIN_ATTR_CMP, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },
  	                       
  { .arduino_id=ARDUINO_PIN_D66,
          GPD_CFG(13, GPD13, INPUT_PULLUP), 
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_CMP, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },
  	                       
  { .arduino_id=ARDUINO_PIN_D67, 
          GPD_CFG(14, GPD14, INPUT_PULLUP), 
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART|PIN_ATTR_DAC, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },

  { .arduino_id=ARDUINO_PIN_D68,
          GPD_CFG(15, GPD15, INPUT_PULLUP), 
  	             .mode=PIN_ATTR_DIGITAL|PIN_ATTR_TIMER |PIN_ATTR_EXTINT|PIN_ATTR_UART|PIN_ATTR_DMA, 
  	                       .ADCChannel=NB_ADC_CHANNEL_MANAGED,   .IO_irqnb=EXINT3_IRQn,    .configured=false },
